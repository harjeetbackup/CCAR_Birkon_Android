...
//	private ImageView videoBut;
    ...
    public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.carddetail);
		 String externalPath = "/data/data/com.spearheadinc.flashcards.birkon/files/";
...
//        	}
	...
	/*	if(hasValueVoice || hasValueComment)
		{
    		cardTopNotesBack.setBackgroundResource(R.drawable.exter_window_ic_yel);
    		cardTopNotesFront.setBackgroundResource(R.drawable.exter_window_ic_yel);
		}
		else
		{
