    ...
    public void onCreate(Bundle savedInstanceState) {
		...
		tv.setOnClickListener(new OnClickListener()
		{
			...
			public void onClick(View v) {
				...
				DecompressZip dz = new DecompressZip( "", "/data/data/com.spearheadinc.flashcards.birkon/", screen.getResources().openRawResource(R.raw.audio) );
				
			      
				if (!dz.doesDirExist("/data/data/com.spearheadinc.flashcards.birkon/files") )
				{
				...
				else
				{
					if(tagValue == false)
					{
						File f = new File("/data/data/com.spearheadinc.flashcards.birkon/files");
						f.delete();
